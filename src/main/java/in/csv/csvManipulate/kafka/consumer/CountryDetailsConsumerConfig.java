...
@Configuration
@EnableKafka
public class CountryDetailsConsumerConfig {
	...
	@Bean("countryDetailsConsumer")
	public CountryDetailsConsumer countryDetailsConsumer() {
		return new CountryDetailsConsumer();
	}
