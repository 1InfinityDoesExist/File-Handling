...
@Configuration
@EnableKafka
public class CountryDetailsProducerConfig {
	...
	@Bean("countryDetailsProducer")
	public CountryDetailsProducer countryDetailsProducer() {
		return new CountryDetailsProducer();
	}
}
